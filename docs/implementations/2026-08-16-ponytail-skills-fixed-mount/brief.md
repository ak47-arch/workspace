...
- **PRD path**: /home/anupam/Desktop/workspace/docs/prd-queue/2026-08-16-ponytail-skills-fixed-mount.md (read-only; also below)
- **Task slug**: ponytail-skills-fixed-mount
- **Impl session UUID**: 0ded66e7-a908-4838-ace5-03de80e8fc0d

...
- **PRD path**: /home/anupam/Desktop/workspace/docs/prd-queue/2026-08-08-extension-inline-agent.md (read-only; also below)
- **Task slug**: extension-inline-agent
- **Impl session UUID**: 60c0c537-b9c7-4c4c-8b8a-0be438950151

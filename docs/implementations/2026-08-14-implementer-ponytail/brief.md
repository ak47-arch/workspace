...
- **PRD path**: /home/anupam/Desktop/workspace/docs/prd-queue/2026-08-14-implementer-ponytail.md (read-only; also below)
- **Task slug**: implementer-ponytail
- **Impl session UUID**: 8483b243-ad9a-4e00-be82-0cdf26a8801d

...
- **PRD path**: /home/anupam/Desktop/workspace/docs/prd-queue/2026-08-17-task-pickup-similarity-merge.md (read-only; also below)
- **Task slug**: task-pickup-similarity-merge
- **Impl session UUID**: b77c5e2b-a870-40c7-bcad-effcbc45332a

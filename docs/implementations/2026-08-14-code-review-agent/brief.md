...
- **PRD path**: /home/anupam/Desktop/workspace/docs/prd-queue/2026-08-13-code-review-agent.md (read-only; also below)
- **Task slug**: code-review-agent
- **Impl session UUID**: d7a5fbb9-c030-4800-8f3d-fb217d36d1cd

...
**Summary**: Run the agent as a local Node service embedding the pi SDK: capture/agent-service/ exposes a WebSocket on 127.0.0.1:8766; the side panel connects to it, sends the pending

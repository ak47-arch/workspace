...
**Summary**: The only capture flow in v1 is Intent A: the hover pill saves the whole tweet (text, external links, embedded/quote tweets, notes). - Standalone text-highlight capture (I

...
**Summary**: review-run.sh mounts the workspaces read-only and passes repeatable pi CLI --skill flags (only in the review invocation) pointing at /workspace/opensource/ponytail/skills

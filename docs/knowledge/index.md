...
- [loop end delivery invariant](sessions/4d89a859-9d05-4b28-9efd-e56aad8837e7/decisions/02-loop-end-delivery-invariant.md)
- [Skills /skills bind mount conditional on host-skills presence](sessions/0ded66e7-a908-4838-ace5-03de80e8fc0d/decisions/01-ponytail-skills-fixed-mount-conditional-mount.md)
...
- [Implementer as host harness + cattle container (brain/hands decoupling)](sessions/019fe7d2-aa31-77e6-8ea0-9df3d6b3c6ed/decisions/01-implementer-harness-host-cattle-container.md)
- [Durable state lives on the host — session outside the container, docs read-only by mount](sessions/019fe7d2-aa31-77e6-8ea0-9df3d6b3c6ed/decisions/02-durable-state-host-session-outside-container.md)
...
- [opensource/ disaster recovery via manifest re-clone — stale fork URLs fall back to upstream](sessions/01a005a8-7302-74e2-8c1a-c6e8e74358c7/decisions/02-opensource-restore-manifest-reclone.md)
